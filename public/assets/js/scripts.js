...
jQuery(document).ready(function() {
    ...
    */
	$('.top-content').backstretch("assets/img/igbomen.jpg");
   /* $('.section-4-container').backstretch([
		"assets/img/carosel/childrenpic.jpg",
		"assets/img/carosel/blacklife2.jpg",
		"assets/img/carosel/Stpatrickday.jpg",
		"assets/img/carosel/menGpic.jpg",
		"assets/img/carosel/ladies.jpg",
		"assets/img/carosel/kidsport.jpg",
], 
